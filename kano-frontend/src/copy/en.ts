...
export const en = {
  ...
  'pm.polls.columns.projectVersion': 'Version',
  ...
  'pm.polls.actions.open': 'Open poll URL in new tab',
  'pm.polls.actions.copy': 'Copy poll URL to clipboard',
  'pm.polls.actions.copied': 'Poll URL copied to clipboard',
  'pm.polls.actions.copyFailed': "We couldn't copy the URL automatically. Please try again.",
